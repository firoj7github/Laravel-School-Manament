    ...
    <div class="carousel-item active slide-one">
     <div class="container">
        <div class="row">
            ...
            <img class="img-1 animate__animated animate__fadeInDown animate__delay-0.5s	" src="{{asset('/img/c6.png')}}" alt="image here">
            <img class="img-2 animate__animated animate__fadeInDown animate__delay-1s	" src="{{asset('/img/c5.png')}}" alt="image here">
            ...
            <div class="col-lg-6 col-md-12 col-12 slider-img">
            <img class="animate__animated animate__fadeInRight animate__delay-1s	" src="{{asset('/img/s1.png')}}" alt="image here">
            </div>
        </div>
     </div>
    </div>
